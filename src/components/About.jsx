  ...
  return (
    <DIV>
      ...
      <p className="about-me-para">
        I am having an affection with computers sice my child hood and got
        inspired by lot of great OOS apps. so I wanted to wet my feet with
        programming and it was the year 2016 i started learning programming. My
        first programming language was python learned in codecademy. I learned
        basics but i don't know how to proceed further with python. However,
        made some small hobby projects in python and pushed into github (don't
        know how to use git so i basically copy and pasted into git).
        <br />
